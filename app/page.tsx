export default async function Home() {
  return (
    <div className="flex flex-col mx-auto items-center  min-h-screen space-y-6 mt-14 ">
      <h1 className="text-5xl text-zinc-300 font-bold mt-11">
        Welcome to the SWAT Family.
      </h1>
      <h2 className="text-2xl max-w-[35%] mt-10 text-zinc-300">
        ...
        as your central hub for training resources, mission briefings, tactical
        updates, and everything you need to dominate the streets of Los Angeles.
        Stay sharp, stay ready, and remember—when the call comes, we answer with
        force.
      </h2>
      <h2 className="font-bold text-3xl mt-4 text-zinc-300">
