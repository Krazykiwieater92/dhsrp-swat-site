    ...
    <>
      <div className="flex mt-10">
        <h1 className="font-bold mx-auto mt-5 text-5xl">
          About LAPD Chief Of Police, B. Lunt
        </h1>
      </div>
      <h2 className="mx-auto max-w-[35%] mt-10 text-2xl">
        Chief B. Lunt is the unwavering force at the top of the LAPD within the
        ...
        officers through high-stakes situations with a steady hand. His
        ...
        the community they protect. With a keen focus on maintaining order in an
        ever-changing environment, Chief Lunt leads with a clear goal: ensuring
